...
class DrugRespDataset(data.Dataset):
    ...
    def __init__(
        ...
        print(f"2*** Drug resp shapes: {self.__drug_resp_df.shape}")
    ...
    def __trim_dataframes(self):
        ...
        rnaseq_index_values = self.__rnaseq_df.index.values
...
if __name__ == '__main__':
    ...
    print(f"Total time taken for [drug_resp_dataset] : {t2 - t1} s")
